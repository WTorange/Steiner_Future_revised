...
# 收益率采用snapshoot中的close计算，由于股指期货都是daily，可以不用考虑夜盘问题。出于兼容性考虑，进行重采样后计算，可以直接使用basis_momentum中的代码
...
if __name__ == '__main__':
    ...
    source_folder = r'\\samba-1.quantchina.pro\quanyi4g\temporary\Steiner\data_wash\linux_so\py311\snapshoot_index_temp'
